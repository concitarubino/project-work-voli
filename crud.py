...
from modelli import Prenotazione, Bagaglio, Pagamento, Biglietto
from schemi import PagamentoSchema
from fastapi import HTTPException

def create_prenotazione(db: Session, prenotazione: Prenotazione) -> Prenotazione:
    db.add(prenotazione)
    db.commit()
...
def salva_pagamento(db: Session, pagamento: PagamentoSchema) -> Pagamento:
    prenotazione = db.query(Prenotazione).filter(Prenotazione.ID_prenotazione == pagamento.ID_prenotazione).first()
